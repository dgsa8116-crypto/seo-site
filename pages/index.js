    ...
    <>
      ...
      <main className="container">
        ...
        <div className="grid grid-4">
          {data.blocks.map((b, i) => (
            <div className="card" key={i}>
              <img className="resp" src={b.img} alt={b.title} style={{ cursor: "zoom-in", borderRadius: "10px" }} onClick={() => setPreview(b.img)} />
              <div className="inner">
      ...
      {preview && (
        <div onClick={() => setPreview(null)} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.85)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 9999 }}>
          <img src={preview} alt="preview" style={{ maxWidth: "90%", maxHeight: "90%", borderRadius: "12px", boxShadow: "0 0 20px rgba(0,0,0,0.5)", objectFit: "contain" }} />
        </div>
      )}
    </>
  );
